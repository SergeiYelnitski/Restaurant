...
VALUES ('Michelin Shaverma', 'Nevsky prospect, Saint Petersburg, Russia', '+375882558899');
...
VALUES ('Admin', 'admin@gmail.com', '{noop}admin', 1),
       ...
       ('Userius', 'userr@yandex.ru', '{noop}password', null),
       ('Useriu', 'usrr@yandex.ru', '{noop}password', null);
